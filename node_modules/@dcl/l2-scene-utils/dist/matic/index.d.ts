...
export declare function balance(address?: string, network?: string): Promise<{
    l1: number;
    l2: number;
}>;
export declare function depositMana(amount: number, network?: string): Promise<string>;
export declare function sendMana(to: string, amount: number, network?: string): Promise<unknown>;
